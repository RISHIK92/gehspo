...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-96 md:h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          <AnimatePresence initial={false} mode="wait">
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-br ${currentBanner.bgGradient}`}
              />
              <div
                className={`absolute inset-0 bg-gradient-to-tr ${currentBanner.accentGradient} opacity-30`}
              />
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-4">
            ...
            <motion.h2
              variants={textVariants}
              className="text-4xl md:text-5xl font-bold text-black mb-6 drop-shadow-lg"
            >
              Our Mission & Vision
            </motion.h2>
            <motion.p
          ...
          >
            <defs>
              ...
              >
                ...
                <path d="M8,8 L12,10 L8,12 Z" fill="white" opacity="0.2" />
              </pattern>
            </defs>
          ...
          <div className="text-center mb-12">
            <motion.div variants={textVariants}>
              <Badge className="mb-6 bg-white bg-opacity-10 text-white border border-white border-opacity-20 px-4 py-2">
                <Play className="h-4 w-4 mr-2" /> Featured Content
              </Badge>
            </motion.div>
            <motion.h2
              variants={textVariants}
            ...
            >
              EHS Excellence in Action
            </motion.h2>
            <motion.p
              variants={textVariants}
              className="text-xl text-gray-300 max-w-3xl mx-auto"
            >
              Discover how GEHSPO is transforming workplace safety and
              environmental standards across industries
            </motion.p>
          </div>
          ...
          <motion.div variants={cardVariants} className="max-w-4xl mx-auto">
            <div className="relative bg-gray-900 bg-opacity-90 border border-gray-700 rounded-2xl shadow-2xl overflow-hidden group">
              <div className="aspect-video relative">
                ...
                >
                  <source
                    src="https://res.cloudinary.com/df622sxkk/video/upload/v1754495957/Video_from_Rishik_Chowdary_1_ebv6lj.mp4"
                    type="video/mp4"
                  />
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-100 mb-3">
                  GEHSPO: Leading EHS Innovation
                </h3>
                <p className="text-gray-300 leading-relaxed">
                  Watch how our organization is setting new standards in
                  environmental, health, and safety management through
                  cutting-edge solutions and professional development programs.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      {/* EHS Excellence Showcase with Images */}
      <motion.section
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.div variants={textVariants}>
              <Badge className="mb-6 bg-white bg-opacity-10 text-white border border-white border-opacity-20 px-4 py-2">
                <Award className="h-4 w-4 mr-2" /> Excellence Showcase
              </Badge>
            </motion.div>
            <motion.h2
              variants={textVariants}
              className="text-4xl md:text-5xl font-bold text-gray-100 mb-6 drop-shadow-lg"
            >
              EHS Excellence in Practice
            </motion.h2>
            <motion.p
              variants={textVariants}
              className="text-xl text-gray-300 max-w-3xl mx-auto"
            >
              Witness the impact of professional EHS management across diverse
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <motion.div
              variants={cardVariants}
              className="bg-gray-900 bg-opacity-90 border border-gray-700 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 group"
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Leading sustainable practices and environmental protection
                  initiatives that reduce carbon footprint and promote
                  ecological responsibility across industries.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Comprehensive occupational health programs and wellness
                  initiatives that prioritize employee wellbeing and create
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  State-of-the-art safety protocols and emergency response
                  systems that prevent incidents and ensure comprehensive
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <motion.div variants={textVariants}>
              <Badge className="mb-6 bg-white bg-opacity-10 text-white border border-white border-opacity-20 px-4 py-2">
                <TrendingUp className="h-4 w-4 mr-2" /> Impact & Results
              </Badge>
            </motion.div>
            <motion.h2
              variants={textVariants}
            ...
            <motion.p
              ...
              className="text-xl text-gray-300 max-w-3xl mx-auto"
            >
              Our commitment to EHS excellence delivers tangible results across
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <motion.div
              variants={cardVariants}
              className="text-center bg-gray-900 bg-opacity-90 border border-gray-700 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 p-8"
            >
