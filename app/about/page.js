    ...
    <div className="max-w-3xl mx-auto px-4 py-12 text-gray-100">
      ...
      <section className="mb-8">
        ...
        <p className="text-lg leading-relaxed">
          Mr. Ghanta Bharat has done Graduation in Physics, pursued P.G. Diploma
          in Industrial Safety, NEBOSH-IGC, IOSH-MS, ISO 45001:2018 Lead
          Auditor, IMS, EMS, Certified Negotiation Manager, Certified Basic
          Management Essentials Professional.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-lg leading-relaxed">
          Mr. Ghanta Bharat is having 15 years of experience in total, with 13
          years in EHS across construction, O&M, and manufacturing industries.
          He has worked in many reputed companies such as ABB India Ltd,
          Wartsila India PVT Ltd, Renewsys India PVT Ltd, Feedback Power India
          PVT Ltd, Sairam Engineering Services India PVT Ltd, PACE Process &
          Controls India PVT Ltd, and PSV PVT Ltd.
        </p>
      </section>
