...
export default function AboutUs() {
  return (
    <div class="max-w-5xl mx-auto px-4 py-12 text-gray-100">
      <h1 class="text-4xl md:text-5xl font-bold mb-8 text-blue-400 text-center drop-shadow-lg">
        Founder & Chief Coordinator of{" "}
        <span class="text-white">WWW.GEHSPO.COM</span>
      </h1>
      ...
      <section class="mb-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 class="text-2xl font-semibold text-blue-300 mb-3">Trainings</h2>
            <ul class="list-disc list-inside text-lg leading-relaxed space-y-1">
              <li>
                NEBOSH Passport Training in Chemical Safety from St. John Health
                & Safety
              </li>
              <li>
                Accredited by ROSPA What Everyone Needs to Know About Permit to
                Work
              </li>
              <li>
      ...
      {/* Experience */}
      <section class="mb-8">
        <h2 class="text-2xl font-semibold text-blue-300 mb-3">Experience</h2>
        <p class="text-lg leading-relaxed">
      ...
      <section>
        ...
        <p class="text-lg leading-relaxed">
          ...
          <br />
          <span class="font-semibold text-blue-200">WWW.GEHSPO.COM</span> is
