...
import { User, Mail, Shield, PenTool, CheckCircle, LogOut } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <CardHeader className="text-center pb-4">
                <div className="flex justify-center mb-4">
                  <Avatar className="h-24 w-24 border-4 border-blue-500 shadow-lg">
                    ...
                    />
                    <AvatarFallback className="bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xl font-semibold">
          ...
          <div className="lg:col-span-2">
            <Card className="shadow-lg border border-gray-700 bg-gray-900/95 backdrop-blur-sm text-white">
              ...
              <CardContent>
                {blogSuccess && (
                  <Alert className="mb-6 border-blue-700 bg-blue-900/80">
                ...
                <form onSubmit={handleBlogSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-12 border-gray-700 focus:border-blue-500 focus:ring-blue-500 bg-gray-800 text-white"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label
                    ...
                    <Textarea
                      ...
                      className="min-h-[200px] border-gray-700 focus:border-blue-500 focus:ring-blue-500 bg-gray-800 text-white resize-none"
                    />
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4">
                    <Button
                      type="submit"
                      className="flex-1 h-12 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold shadow-lg flex items-center justify-center"
                      disabled={loading}
                    >
                      {loading ? (
              ...
              {blogsLoading ? (
                ...
                <div className="space-y-6">
                  {blogs.map((blog) => (
                    <div
                      key={blog.id}
                      className="bg-gray-900/80 border border-gray-700 rounded-lg p-6 shadow"
                    >
